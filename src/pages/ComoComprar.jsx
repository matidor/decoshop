  ...
  return (
    <div>
      <section className="como-comprar">
        ...
        <h1>¿Como comprar?</h1>
        <p>Para hacer una compra, simplemente sigue estos pasos:</p>
        <ol className="centered-list">
          ...
          <li>
            <FaCheckCircle className="icon-check" />
            Haz clic en el botón "Agregar al carrito" para cada producto que
            desees comprar.
          </li>
          <li>
            <FaCheckCircle className="icon-check" />
          ...
          <li>
            <FaCheckCircle className="icon-check" />
            Confirma tu compra y recibirás una confirmación por correo
            electrónico.
          </li>
        </ol>
        <p>
          Si tienes alguna pregunta o necesitas asistencia durante el proceso de
          compra, no dudes en <a href="/contacto">contactarnos</a>.
        </p>
        <p>
          Cualquier inquietud, podes escribirnos a nuestro WhatsApp 👉
          2255609449
        </p>{" "}
        <br />
        <p>
